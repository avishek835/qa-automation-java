...
public class GMailTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        //Don't Change below line. Set this value in test.properties file in case you need to change it..
    ...
    public void testSendEmail() throws Exception {
        ...
        driver.findElement(By.xpath("//input[@name='subjectbox' and @id=':r5']")).sendKeys(emailSubject);
        driver.findElement(By.xpath("//table[@id='undefined' and @class='cf An']")).sendKeys(emailBody);
